...
HD_PWD='C:/Users/Lingke/Desktop/FYP/FYP_AI_on_FPGA/UART_interface_integrated_1_layer_CNN/UART_interface_integrated_1_layer_CNN.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log myip.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source myip.tcl -notrace
