...
HD_PWD='C:/Users/Lingke/Desktop/FYP/FYP_AI_on_FPGA/Testing_BRAM/Testing_BRAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CONV1D_2nd_Data_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CONV1D_2nd_Data_RAM.tcl
